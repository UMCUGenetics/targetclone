...
def generatePolyclonalityFigure(simulationFolder, noiseLevels, contaminationLevels):
	...
	for contaminationLevel in contaminationLevels:
		dataFolder = simulationFolder + str(contaminationLevel) + 'Clones'
...
contaminationLevels = [10, 20, 30, 40, 50]

simulationFolder = '../Results/noise2Mu' #Folder to look in for the results
