files = dict(
	...
	outputDir = 'Results/mixedSubclones_31_40_2/',
...
general = dict(
	...
	maximumMinorCloneFrequency = 40, #This value should change between simulations to see the effects
	minimumMinorCloneFrequency = 31, #To test between 0 and 10, we set this value to 1. A value of 0 makes no sense for this test.
