files = dict(
	...
	outputDir = 'Results/mixedSubclones_31_40_3/',
...
general = dict(
	...
	numberOfMixedClones = 3, #This is the number of subclones that we mix in on top of the major clone! The name of this setting needs to be better. 
