files = dict(
	...
	outputDir = 'Results/mixedSubclones_21_30_2/',
...
general = dict(
	...
	numberOfMixedClones = 2, #This is the number of subclones that we mix in on top of the major clone! The name of this setting needs to be better. 
	maximumMinorCloneFrequency = 30, #This value should change between simulations to see the effects
	minimumMinorCloneFrequency = 21, #To test between 0 and 10, we set this value to 1. A value of 0 makes no sense for this test.
