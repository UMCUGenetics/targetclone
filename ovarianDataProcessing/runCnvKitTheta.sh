...
#	#2.2 Generate the tumor.snp files for theta
	...
	"$thetaPath"/bin/RunTHetA "$intervalCountFile" --TUMOR_FILE "$d"/cnvKit/tumor.snp_formatted_corrected.txt --NORMAL_FILE "$d"/cnvKit/normal.snp_formatted.txt --BAF --FORCE -n 2
	##
